...
import recursoIndustria from "@/assets/img/recurso-industria.png"; // ← Cambia por una imagen representativa: fábrica moderna, robots en diferentes sectores, líneas de producción variadas (ej. manufactura + alimentos + energía)

export function HeroIndustria() {
  const industries = [
  ...
  return (
    <section id="industria" className="relative min-h-screen flex items-center pt-20 overflow-hidden">
      {/* Background Image with Overlay */}
      <div className="absolute inset-0 z-0">
        <ImageWithFallback
          src={recursoIndustria}
          alt="Sectores Industriales Automatizados"
          className="w-full h-full object-cover"
        />
        {/* Gradients para mantener el estilo de marca */}
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 py-20">
        <div className="max-w-4xl">
          ...
          >
            Diseñamos e implementamos soluciones de automatización personalizadas para 
            diversos sectores industriales. Desde manufactura hasta energía, maximizamos 
            eficiencia, seguridad y competitividad en cada operación.
          </motion.p>

          {/* Lista de industrias atendidas (en lugar de features genéricas) */}
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            {industries.map((industry, index) => (
              ...
              >
                ...
                <span className="text-base font-medium text-foreground">{industry}</span>
              </div>
            ))}
          </motion.div>

          {/* CTA Buttons - Enfocados en acción */}
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          {/* Stats adaptados a multissetorial */}
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            {[
              ...
              { value: "95%", label: "Proyectos Exitosos" },
      ...
      >
        <div className="flex flex-col items-center gap-2">
          <span className="text-xs text-muted-foreground font-medium">Conoce más sectores</span>
